define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/vip_auth/index' + location.search,
                    add_url: 'user/vip_auth/add',
                    edit_url: 'user/vip_auth/edit',
                    del_url: 'user/vip_auth/del',
                    multi_url: 'user/vip_auth/multi',
                    table: 'user',
                }
            });
                ...
                columns: [
                    [
                        ...
                        // {field: 'idcard_rs', title: __('Idcard_rs')},
                        {
                            field: 'vip_auth',
                            title: __('Vip_auth'),
                            searchList: {"0": __('Vip_auth 0'), "1": __('Vip_auth 1'), "2": __('Vip_auth 2')},
                            formatter: Table.api.formatter.normal
                        },
