define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/id_auth/index' + location.search,
                    add_url: 'user/id_auth/add',
                    edit_url: 'user/id_auth/edit',
                    del_url: 'user/id_auth/del',
                    multi_url: 'user/id_auth/multi',
                    table: 'user',
                }
            });
                ...
                columns: [
                    [
                        ...
                        // {field: 'tv', title: __('Tv')},
                        {
                            field: 'id_auth',
                            title: __('Id_auth'),
                            searchList: {"0": __('Id_auth 0'), "1": __('Id_auth 1'), "2": __('Id_auth 2')},
                            formatter: Table.api.formatter.normal
                        },
