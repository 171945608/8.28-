define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'position/home_one/index' + location.search,
                    add_url: 'position/home_one/add',
                    edit_url: 'position/home_one/edit',
                    del_url: 'position/home_one/del',
                    multi_url: 'position/home_one/multi',
                    table: 'position',
                }
            });
