...
class Shop extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign("auditStateList", $this->model->getAuditStateList());
    }
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try {
                    ...
                    $res = Mine::setShop($params['id'], [
                        'audit_state' => $params['audit_state'],
                        'audit_msg'  => $params['audit_msg'],
                    ]);

                    if ($params['audit_state'] == Mine::AUDIT_STATE_SUCCESS) {
                        Mine::initStore($params['id']);
                    }
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try {
                    ...
                    $res = Mine::forbidShop($params['id'], $params['forbid_type']);
