...
class VipAuth extends Backend
{
    ...
    /**
     * VipAuth模型对象
     * @var \app\admin\model\user\VipAuth
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\user\VipAuth;
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try {
                    ...
                    switch ((int)$params['vip_auth']) {
                        case 0:
                            $res = \app\api\model\User::rejectVipAuth($params['id']);
                            break;

                        case 2:
                            $res = \app\api\model\User::passVipAuth($params['id']);
                            break;
